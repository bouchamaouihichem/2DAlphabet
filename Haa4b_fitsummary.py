...
output_dir = "Plotting/Fits/"

# File pattern for toy fit diagnostics
for channel in ['LepHi', 'LepLo', 'gg0lHi', 'gg0lLo']:
    for mass in ['15', '30', '55']:
        file_pattern = f"{input_dir}fitDiagnostics.testFitDiagnostics.mA_{mass}.{channel}.toy*.root"
        ...
        c.SaveAs(f"{output_dir}bias_r_over_rErr_{channel}_{mass}.png")
