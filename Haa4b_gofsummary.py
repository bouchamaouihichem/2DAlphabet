...
for channel in ['leptonic', 'vbf', 'ggh']:
    for mass in ['15', '30', '55']:
        
        directory = "raw_outputs_gof"
        # getting expected value
        file_expected =  f"{directory}/higgsCombine.goodnessOfFit_MC_ma_{mass}.{channel}.GoodnessOfFit.mH125.root"
        ...
        file_observed =  f"{directory}/higgsCombine.goodnessOfFit_MC_ma_{mass}.{channel}.GoodnessOfFit.mH125.123456.root"
        ...
        # Save canvas
        c.SaveAs(f"{directory}/gof_{channel}_{mass}.png")
